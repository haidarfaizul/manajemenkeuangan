  ...
  <table align="left" cellspacing="0" border="0">
    ...
    <div class="">
      <tr>
        ...
        <td colspan="14" height="35" align="center" valign="middle">
          <b class="flex justify-start items-center ">
            <img src="../asset/Logo.png" width="70" height="34" class="mr-23" />
            <font size="5" color="#231F20">NINDYA BETON &ndash; SIER PUSPAUTAMA KSO</font>
          </b>
        </td>
      </tr>
      <tr>
        <td colspan="14" height="23" align="center" valign="middle">
          <b>
            <font size="2" color="#231F20">Pembangunan Gudang Modern - Distribution Center (DC) BULOG di
      ...
      <tr>
        <td colspan="14" height="23" align="center" valign="middle">
          <b>
            <font size="1" color="#C9574C">Jl. Panjang Jiwo No.44, Panjang Jiwo, Kec. Tenggilis Mejoyo,
    ...
    <tr>
      ...
      <td
        ...
        valign="middle">
        <b>
          <font size="3" color="#000000"><?php echo "NO.     /KAS/$bulan/$tahun"; ?></font>
        </b>
      </td>
    </tr>
    <tr></tr>
    <tr>
      <td colspan="14" height="20" align="center" valign="middle">
        <b><u>
            <font size="4" color="#000000">BUKTI PENGELUARAN KAS/BANK
            </font>
          </u></b>
      </td>
    </tr>
    ...
    <tr>
      <td colspan="2" height="21" align="left" valign="middle">
        <b>
          <font size="2" color="#000000">DIBAYARKAN KEPADA</font>
        </b>
      </td>
    ...
    <tr>
      <td colspan="2" height="25" align="left" valign="middle">
        <b>
          <font size="2" color="#000000">ALAMAT</font>
        </b>
      </td>
      <td align="center" valign="middle">
        <b>
    ...
    <tr>
      <td colspan="2" height="21" align="left" valign="middle">
        <b>
          <font size="2" color="#000000">BANYAKNYA</font>
        </b>
      </td>
      <td align="center" valign="middle">
        <b>
      ...
      <td id="undercell" colspan="5" align="left" valign="middle">
        <b>
          <font size="2" color="#000000">Rp <?php echo number_format($total_nominal, 0, ',', '.'); ?></font>
        </b>
      </td>
      <td colspan="3" align="left" valign="bottom">
        <b>
          <font size="2" color="#000000"> TERBILANG :</font>
        </b>
      </td>
    ...
    <tr>
      <td colspan="2" height="21" align="left" valign="middle">
        <b>
          <font size="2" color="#000000">BERUPA</font>
        </b>
      </td>
      <td align="center" valign="middle">
        <b>
      ...
      <td
        ...
        bgcolor="#FFFFFF">
        <b>
          <font color="#000000">TUNAI / CHEQUE / GB / NPB / NO. </font>
        </b>
      </td>
    ...
    <tr>
      ...
      <td colspan="2" align="left" valign="middle">
        <b>
          <font size="2" color="#000000">BANK </font>
        </b>
      </td>
    ...
    <tr>
      ...
      <td id="cell" colspan="7" align="left" valign="middle">
        <b><u>
            <font face="Tahoma" size="2" color="#000000">Pembayaran atas :</font>
          </u></b>
      </td>
      <td
        id="cell"
    ...
    <tr>
      ...
      <td id="cell" colspan="7" align="left" valign="middle">
        <b><u>
            <font face="Tahoma" color="#000000">Perhitungan Pembayaran :</font>
          </u></b>
      </td>
      <td
        id="cell"
    ...
    <tr>
      ...
      <td
        ...
        valign="middle">
        <b>
          <font face="Tahoma" color="#000000"> RP <?php echo number_format($total_nominal, 0, ',', '.'); ?></font>
        </b>
      </td>
      <td
        id="cell"
    ...
    <tr>
      ...
      <td id="cell" colspan="3" align="center" valign="middle">
        <i>
          <font face="Tahoma" color="#000000">Bukti2 terlampir</font>
        </i>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td
        ...
        sdnum='1033;0;_("Rp"\.* #,##0_);_("Rp"* \(#,##0\);_("Rp"* "-"??_);_(@_)'>
        <b>
          <font size="2" color="#000000"> <?php echo $row['name']; ?> </font>
        </b>
      </td>
    </tr>
  </table>
